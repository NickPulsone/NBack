...
CHUNK_DIR_NAME = "nback_test1_reponse_chunks"
...
letter_array = np.array(data[:, 0], dtype=str)
...
for i in iteration_indices:
    if len(user_responses[i]) > 0 and user_responses[i] != "N/A" and reaction_times[i] > DELAY:
